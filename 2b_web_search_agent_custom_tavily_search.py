...
def main():
    ...
    result = agent.invoke({"messages": HumanMessage(content="Search for 3 jobs for an ai engineeer or data scientist with agentic experience in Bengaluru Karnataka on linkedin and list their details")})
